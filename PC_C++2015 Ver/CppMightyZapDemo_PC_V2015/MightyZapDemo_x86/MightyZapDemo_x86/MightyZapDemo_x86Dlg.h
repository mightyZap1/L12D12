...
class CMightyZapDemo_x86Dlg : public CDialogEx
{
// 생성입니다.
public:
	CMightyZapDemo_x86Dlg(CWnd* pParent = NULL);	// 표준 생성자입니다.

// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_MIGHTYZAPDEMO_X86_DIALOG };
#endif
