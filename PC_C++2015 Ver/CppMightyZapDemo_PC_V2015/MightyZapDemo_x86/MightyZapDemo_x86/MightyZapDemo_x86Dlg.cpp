...
// MightyZapDemo_x86Dlg.cpp : 구현 파일
//

#include "stdafx.h"
#include "MightyZapDemo_x86.h"
#include "MightyZapDemo_x86Dlg.h"
#include "afxdialogex.h"

#include "../lib/CppDllMightyZap_2015.h"
...
// CMightyZapDemo_x86Dlg 대화 상자



CMightyZapDemo_x86Dlg::CMightyZapDemo_x86Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MIGHTYZAPDEMO_X86_DIALOG, pParent)
	, m_nSettingPort(_T(""))
	, m_nSettingBaud(0)
	, m_nServoID(0)
	, m_nPosition(0)
...
void CMightyZapDemo_x86Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMightyZapDemo_x86Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_Connect, &CMightyZapDemo_x86Dlg::OnBnClickedConnect)
	ON_BN_CLICKED(IDC_GoalPosition, &CMightyZapDemo_x86Dlg::OnBnClickedGoalposition)
	ON_BN_CLICKED(IDC_Btn_SStrokeLimit, &CMightyZapDemo_x86Dlg::OnBnClickedBtnSstrokelimit)
	ON_BN_CLICKED(IDC_Btn_LStrokeLimit, &CMightyZapDemo_x86Dlg::OnBnClickedBtnLstrokelimit)
	ON_BN_CLICKED(IDC_Btn_PresentPosition, &CMightyZapDemo_x86Dlg::OnBnClickedBtnPresentposition)
	ON_BN_CLICKED(IDC_Btn_AddrWrite, &CMightyZapDemo_x86Dlg::OnBnClickedBtnAddrwrite)
	ON_BN_CLICKED(IDC_Btn_AddrRead, &CMightyZapDemo_x86Dlg::OnBnClickedBtnAddrread)
	ON_BN_CLICKED(IDC_ReadError, &CMightyZapDemo_x86Dlg::OnBnClickedReaderror)
	ON_BN_CLICKED(IDC_ReadShutdown, &CMightyZapDemo_x86Dlg::OnBnClickedReadshutdown)
	ON_BN_CLICKED(IDC_WriteShutdowm, &CMightyZapDemo_x86Dlg::OnBnClickedWriteshutdowm)
END_MESSAGE_MAP()


// CMightyZapDemo_x86Dlg 메시지 처리기

BOOL CMightyZapDemo_x86Dlg::OnInitDialog()
{
...
void CMightyZapDemo_x86Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMightyZapDemo_x86Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CMightyZapDemo_x86Dlg::OnQueryDragIcon()
{
...
void CMightyZapDemo_x86Dlg::OnBnClickedConnect()
{
	...
	if (isOpen == 0) {
		...
		//mightyzap->SerialTimeout(1,1,1,1,1);

		GetDlgItem(IDC_Connect)->SetWindowTextW(L"Disconnect");
		...
		GetDlgItem(IDC_Connect)->SetWindowTextW(L"Connect");
...
void CMightyZapDemo_x86Dlg::ErrorRead()
{
...
void CMightyZapDemo_x86Dlg::OnBnClickedGoalposition()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
...
void CMightyZapDemo_x86Dlg::OnBnClickedBtnSstrokelimit()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.	
	UpdateData(TRUE);
...
void CMightyZapDemo_x86Dlg::OnBnClickedBtnLstrokelimit()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
	//                   Servo ID  Addr byte  data
...
void CMightyZapDemo_x86Dlg::OnBnClickedBtnPresentposition()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	short data;
	CString str;
...
void CMightyZapDemo_x86Dlg::OnBnClickedBtnAddrwrite()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
...
void CMightyZapDemo_x86Dlg::OnBnClickedBtnAddrread()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
	short data;
...
void CMightyZapDemo_x86Dlg::OnBnClickedReaderror()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
	mightyzap->ReadError(m_nServoID, error);
...
void CMightyZapDemo_x86Dlg::OnBnClickedReadshutdown()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
	unsigned char ShutDownError;
...
void CMightyZapDemo_x86Dlg::OnBnClickedWriteshutdowm()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData(TRUE);
